...
<body>
    <div id="title">
        ...
        <h1>sur le thème</h1>
        <h2>!! STAR 80 !!</h2>
        <button id="party"onclick="displayExplanations()">en savoir plus</button>
    ...
    <div id="adress">
        ...
        <button id="lieu"onclick="adressToParty()">clique ici pour connaître l'adresse</button>
    </div>
    ...
    <form method="post" action="register.php">
        ...
        <input id="envoyer"type="submit" name="submit" value="Envoyer"></br>
